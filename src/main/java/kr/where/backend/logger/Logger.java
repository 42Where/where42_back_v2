...
public enum Logger {
    ...
    CREATE_AGREE_MEMBER("[INFO] : 새로운 동의-멤버'{}'님이 등록되었습니다."),
    CREATE_DISAGREE_MEMBER("[INFO] : 새로운 비동의-멤버'{}'님이 등록되었습니다."),
    UPDATE_MEMBER_COMMENT("[INFO] : '{}'님이 상태메세지를 {}로 변경하였습니다."),
    UPDATE_MEMBER_LOCATION("[INFO] : '{}'님의 자리가 {}에서 {}로 변경되었습니다."),
    UPDATE_MEMBER_CUSTOM_LOCATION("[INFO] : '{}'님이 {}로 수동 설정하였습니다."),
    UPDATE_MEMBER_IMAC_LOCATION("[INFO] : '{}'님이 {}로 변경되었습니다."),
    UPDATE_MEMBER_INCLUSTER("[INFO] : '{}'님이 {}하였습니다."),
