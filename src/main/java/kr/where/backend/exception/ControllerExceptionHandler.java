...
import kr.where.backend.exception.customExceptionBysuhwpark.ErrorResponse;
...
public class ControllerExceptionHandler {
    ...
    protected ResponseEntity handleTokenException(final CustomException e) {
        log.info(e.toString());
        return ResponseEntity.status(HttpStatus.UNAUTHORIZED).body(ErrorResponse.form(e));
    }
