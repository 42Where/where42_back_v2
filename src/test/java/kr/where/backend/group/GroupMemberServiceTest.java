...
//         Given
        ...
        responseMemberDto = memberService.createAgreeMember(createMemberDto);
    ...
    public void 그룹_멤버_생성() throws Exception {
        ...
        memberService.createAgreeMember(groupmember);
    ...
    public void 그룹_멤버_조회() throws Exception{
        ...
        memberService.createAgreeMember(groupmember1);
        CreateMemberDto groupmember2 = CreateMemberDto.create(22224L, "jonhan", 1, "img");
        memberService.createAgreeMember(groupmember2);
